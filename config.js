...
// Direct ngrok tunnel pipeline with zero proxy interference
export const N8N_GATEWAY_WEBHOOK = 'https://terminal-n8n-gateway.onrender.com/webhook/strait_of_hormuz';
//export const N8N_GATEWAY_WEBHOOK = '[https://terminal-n8n-gateway.onrender.com](https://terminal-n8n-gateway.onrender.com)/webhook/starit_of_hormuz ';
